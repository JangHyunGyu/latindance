var BUSAN_VENUES = [
  {
    id: "busan-lalala",
    name: { ko: "라라라살사", en: "LaLaLa Salsa", es: "LaLaLa Salsa" },
    ...
    address: {
      ...
      es: "5F, Bujeon-ro 20beon-gil, Busanjin-gu, Busan"
    },
    ...
    summary: {
      ...
      es: "Comunidad latina de Busan que organiza múltiples reuniones semanales en Gwangalli y Seomyeon, fomentando amistades cercanas, ofreciendo sesiones de salsa para personas de mediana edad y organizando eventos sociales de intercambio."
    },
    image: "assets/images/lalala.png",
    imageAlt: {
      ko: "라라라살사 로고",
      en: "LaLaLa Salsa logo",
      es: "Logotipo de LaLaLa Salsa"
    },
    links: [
  ...
  {
    id: "busan-rueda",
    name: { ko: "루에다", en: "Rueda", es: "Rueda" },
    region: { ko: "부산", en: "Busan", es: "Busan" },
    city: { ko: "부산 부산진구", en: "Busanjin-gu", es: "Busanjin-gu" },
    address: {
      ko: "부산광역시 부산진구 신천대로62번길 42 2층",
      en: "2F, 42 Sincheon-daero 62beon-gil, Busanjin-gu, Busan",
      es: "2F, 42 Sincheon-daero 62beon-gil, Busanjin-gu, Busan"
    },
    styles: ["salsa", "bachata"],
    summary: {
      ...
      es: "Instructores veteranos y una lista internacional de miembros lideran esta comunidad latina de Busan, que ofrece un curso gratuito para principiantes de un mes, clases continuas, animados eventos sociales después de la práctica y actualizaciones activas en Band e Instagram para que los bailarines puedan seguir disfrutando de la salsa y la bachata durante todo el año."
    },
    image: "assets/images/rueda.png",
    imageAlt: {
      ko: "루에다 부산 로고",
      en: "Rueda Busan logo",
      es: "Logotipo de Rueda Busan"
    },
    links: [
  ...
  {
    id: "busan-zouk",
    name: { ko: "부산 주크", en: "Zouk Busan", es: "Zouk Busan" },
    region: { ko: "부산", en: "Busan", es: "Busan" },
    city: { ko: "부산", en: "Busan", es: "Busan" },
    address: {
      ko: "",
      en: "",
      es: ""
    ...
    summary: {
      ...
      es: "Comunidad de Busan que comparte la belleza del Zouk brasileño a través de clases regulares y reuniones sociales."
    },
    image: "assets/images/busan_zouk.png",
    imageAlt: {
      ko: "부산 주크 로고",
      en: "Zouk Busan logo",
      es: "Logotipo de Zouk Busan"
    },
    links: [
  ...
  {
    id: "busan-nobless",
    name: { ko: "노블레스", en: "Nobless", es: "Nobless" },
    region: { ko: "부산", en: "Busan", es: "Busan" },
    city: { ko: "부산 부산진구", en: "Busanjin-gu", es: "Busanjin-gu" },
    address: {
      ko: "부산광역시 부산진구 신천대로 102번길 37",
      en: "37 Sincheon-daero 102beon-gil, Busanjin-gu, Busan",
      es: "37 Sincheon-daero 102beon-gil, Busanjin-gu, Busan"
    },
    styles: ["salsa", "bachata"],
    summary: {
      ...
      es: "Club latino para bailarines de 40 y 50 años con sesiones los lunes, enseñando salsa, bachata junto con eventos sociales de vino y buffet."
    },
    image: "assets/images/noblesse.png",
    imageAlt: {
      ko: "노블레스 부산 로고",
      en: "Nobless Busan logo",
      es: "Logotipo de Nobless Busan"
    },
    links: [
  ...
  {
    id: "busan-bliss",
    name: { ko: "블리스", en: "Bliss", es: "Bliss" },
    region: { ko: "부산", en: "Busan", es: "Busan" },
    city: { ko: "부산 부산진구", en: "Busanjin-gu", es: "Busanjin-gu" },
    address: {
      ko: "부산광역시 부산진구 부전동 520-31 4층",
      en: "4F, 520-31 Bujeon-dong, Busanjin-gu, Busan",
      es: "4F, 520-31 Bujeon-dong, Busanjin-gu, Busan"
    },
    ...
    summary: {
      ...
      es: "Estudio en el cuarto piso en Bujeon-dong que ofrece clases de salsa, bachata y kizomba en grupos pequeños, además de eventos sociales después del trabajo, facilitando que los bailarines se unan y conecten."
    },
    image: "assets/images/bliss.png",
    imageAlt: {
      ko: "블리스 라틴댄스 로고",
      en: "Bliss Latin Dance logo",
      es: "Logotipo de Bliss Latin Dance"
    },
    links: [
  ...
  {
    id: "busan-latino",
    name: { ko: "라티노", en: "Latino", es: "Latino" },
    region: { ko: "부산", en: "Busan", es: "Busan" },
    city: { ko: "부산 부산진구", en: "Busanjin-gu", es: "Busanjin-gu" },
    address: {
    ...
    summary: {
      ...
      es: "Fundado en 2001 como el corazón de la salsa en Busan, este club ofrece clases diarias de salsa, bachata y kizomba, eventos sociales abiertos para recién llegados y exhibiciones regulares que mantienen próspera la cultura latina."
    },
    image: "assets/images/latino.png",
    imageAlt: {
      ko: "라티노 부산 로고",
      en: "Latino Busan logo",
      es: "Logotipo de Latino Busan"
    },
    links: [
  ...
  {
    id: "busan-salsafit",
    name: { ko: "살사핏 댄스학원", en: "Salsafit Dance Academy", es: "Salsafit Dance Academy" },
    region: { ko: "부산", en: "Busan", es: "Busan" },
    city: { ko: "부산 부산진구", en: "Busanjin-gu", es: "Busanjin-gu" },
    address: {
      ko: "부산광역시 부산진구 신천대로 50번길 72",
      en: "72 Sincheon-daero 50beon-gil, Busanjin-gu, Busan",
      es: "72 Sincheon-daero 50beon-gil, Busanjin-gu, Busan"
    },
    styles: ["salsa", "bachata"],
    summary: {
      ...
      es: "Academia de baile latino en Busanjin-gu que combina currículos estructurados de salsa y bachata con entrenamiento inspirado en el fitness, guiando a los estudiantes desde los fundamentos hasta el baile social y dando la bienvenida a principiantes durante todo el año."
    },
    image: "assets/images/salsa_fit.png",
    imageAlt: {
      ko: "살사핏 로고",
      en: "Salsafit logo",
      es: "Logotipo de Salsafit"
    },
    links: [
  ...
  {
    id: "busan-lydance",
    name: { ko: "LY댄스 스튜디오 부산", en: "LY Dance Studio Busan", es: "LY Dance Studio Busan" },
    region: { ko: "부산", en: "Busan", es: "Busan" },
    city: { ko: "부산 부산진구", en: "Busanjin-gu", es: "Busanjin-gu" },
    address: {
      ko: "부산광역시 부산진구 신천대로 108 지하 1층",
      en: "B1, 108 Sincheon-daero, Busanjin-gu, Busan",
      es: "B1, 108 Sincheon-daero, Busanjin-gu, Busan"
    },
    styles: ["salsa", "bachata"],
    summary: {
      ...
      es: "Estudio de baile latino cerca de Sincheon-daero en Busanjin-gu que comparte actualizaciones a través de sus canales de Naver Cafe, Band, Instagram y YouTube, mientras que su equipo de instructores dirige programas estructurados de salsa y bachata."
    },
    image: "assets/images/ly_dance_studio.png",
    imageAlt: {
      ko: "LY댄스 스튜디오 부산 로고",
      en: "LY Dance Studio Busan logo",
      es: "Logotipo de LY Dance Studio Busan"
    },
    links: [
  ...
  {
    id: "busan-mamboclub",
    name: { ko: "맘보클럽", en: "Mambo Club Busan", es: "Mambo Club Busan" },
    region: { ko: "부산", en: "Busan", es: "Busan" },
    city: { ko: "부산 부산진구", en: "Busanjin-gu", es: "Busanjin-gu" },
    address: {
      ko: "부산광역시 부산진구 부전동 520-38",
      en: "520-38 Bujeon-dong, Busanjin-gu, Busan",
      es: "520-38 Bujeon-dong, Busanjin-gu, Busan"
    },
    styles: ["salsa", "bachata"],
    summary: {
      ...
      es: "Club latino de Busan que organiza eventos sociales y talleres de salsa, bachata y kizomba entre semana, manteniendo un ambiente amigable para los recién llegados."
    },
    image: "assets/images/mambo.png",
    imageAlt: {
      ko: "맘보클럽 로고",
      en: "Mambo Club logo",
      es: "Logotipo de Mambo Club"
    },
    links: [
  ...
  {
    id: "busan-feeldance",
    name: { ko: "필댄스 부산", en: "Feel Dance Busan", es: "Feel Dance Busan" },
    region: { ko: "부산", en: "Busan", es: "Busan" },
    city: { ko: "부산 부산진구", en: "Busanjin-gu", es: "Busanjin-gu" },
    address: {
      ko: "부산광역시 부산진구 부전로 95 이현빌딩 4층",
      en: "4F, Ihyeon Building, 95 Bujeon-ro, Busanjin-gu, Busan",
      es: "4F, Ihyeon Building, 95 Bujeon-ro, Busanjin-gu, Busan"
    },
    styles: ["salsa", "bachata"],
    summary: {
      ...
      es: "Club social latino para personas de 20 y 30 años en Busan, Changwon y Daegu, que da la bienvenida a principiantes absolutos para disfrutar de la salsa y la bachata, mantenerse conectados en las redes sociales y construir amistades a través del baile."
    },
    image: "assets/images/feeldance.png",
    imageAlt: {
      ko: "필댄스 로고",
      en: "Feel Dance logo",
      es: "Logotipo de Feel Dance"
    },
    links: [
