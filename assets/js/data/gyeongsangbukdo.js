var GYEONGSANGBUKDO_VENUES = [
  {
    id: "gumi-arte",
    name: { ko: "구미 아르떼", en: "Gumi Arte", es: "Gumi Arte" },
    region: { ko: "경북", en: "Gyeongsangbuk-do", es: "Gyeongsangbuk-do" },
    city: { ko: "경북 구미시", en: "Gumi-si", es: "Gumi-si" },
    address: {
      ko: "경북 구미시 송원서로2길 37-1 4층",
      en: "4F, 37-1 Songwonseo-ro 2-gil, Gumi-si, Gyeongsangbuk-do",
      es: "4F, 37-1 Songwonseo-ro 2-gil, Gumi-si, Gyeongsangbuk-do"
    },
    ...
    summary: {
      ...
      es: "Comunidad en el centro de Gumi que hace crecer la escena latina local con clases de salsa y bachata para principiantes y eventos sociales de fin de semana."
    },
    image: "assets/images/arte.png",
    imageAlt: {
      ko: "구미 아르떼 로고",
      en: "Gumi Arte logo",
      es: "Logotipo de Gumi Arte"
    },
    imageFit: "contain",
    links: [
  ...
  },
  {
    ...
    address: {
      ...
      es: "4F, 112 Jungang-ro, Nam-gu, Pohang-si, Gyeongsangbuk-do"
    },
    styles: ["salsa", "bachata"],
    summary: {
      ...
      es: "Comunidad de baile latino de Pohang que ofrece clases paso a paso de salsa y bachata que dan la bienvenida a los principiantes, fomentando un espacio alegre para que los trabajadores de oficina se recarguen, y conocida por sus enérgicos eventos de salsa en la playa y fiestas de aniversario a gran escala que atraen a bailarines de toda Corea."
    },
